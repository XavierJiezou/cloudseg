...
<<<<<<< HEAD
        ...
        self.image = L8BiomeImage(root, crs, res, bands, transforms, cache)
        self.mask = L8BiomeMask(root, crs, res, None, transforms, cache)
...
=======
    ...
    def __get_img_ann(self, filename: str):
        ...
        for bands in self.bands:
            ...
            if image is None:
                image = im
>>>>>>> 40270e273760184905fc7b0dac7219eb33a40d5e
            else:
