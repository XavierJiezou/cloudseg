...
- [x] @zs: l8_biome_crop数据集两个方法评测（建立总表和class-wise两个表）
- [x] @zs: l8_biome_crop数据集两个方法在场景上的评测（建一个表）
- [x] @zs: 各个数据集上的可视化（l8_biome需要支持多个场景）
- [ ] @zxc: sam在l1c和l2a以及l8三个数据集上的评测结果
- [ ] @zxc: 完成我们的方法的提案（初步的pipeline）
